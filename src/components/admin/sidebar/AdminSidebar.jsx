...
import { schoolMenuItems } from "@/utils/schoolNavigation";
...
export function AdminSidebar() {
  ...
  const isExactPath = (path) => {
    if (path === "/school") {
      return location.pathname === path || location.pathname === "/school/";
    }
  };
        ...
        <SidebarMenu className="space-y-1">
          {schoolMenuItems.map((item, index) => {
            ...
            const isActive = hasSubItems
              ...
              : isExactPath("/school"); // Only exact match for Dashboard
              ...
              >
                <CollapsibleTrigger asChild>
                  <SidebarMenuItem>
                    ...
                    {!hasSubItems ? (
                      <Link to="/school" className="block">
                        <SidebarMenuButton
