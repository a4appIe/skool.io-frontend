...
import createFormDataStudentEdit from "./createFormDataStudentEdit";
import createFormDataStudent from "./createFormDataStudent";
...
export function StudentAdmissionForm({ edit = false, studentId = null }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (edit) {
        ...
        await updateStudent(studentData._id, fd);
      } else {
